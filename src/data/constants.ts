...
const PREFIX = 'cssselectorsapp123321_';
export const STORAGE_LEVEL_KEY = `${PREFIX}level`;
export const STORAGE_PROGRESS_KEY = `${PREFIX}progress`;
export const STORAGE_PASSED_LEVELS_KEY = `${PREFIX}passed`;
